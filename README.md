...
<div style="background-color: #1a1b26; border: 1px solid #24283b; border-top: 1px solid #383e5a; border-left: 1px solid #383e5a; border-bottom: 3px solid #0d0e15; border-right: 3px solid #0d0e15; border-radius: 12px; padding: 20px; font-family: monospace; color: #a9b1d6; margin: 20px 0; box-shadow: 0 4px 20px rgba(0,0,0,0.3);">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td align="left" valign="middle">
        <span style="color: #ff007c; font-size: 16px;">●</span>
        <span style="color: #ff9e64; font-size: 16px; margin: 0 4px;">●</span>
        <span style="color: #1abc9c; font-size: 16px;">●</span>
        <b style="color: #70a5fd; margin-left: 10px; font-size: 14px;">about_me.json</b>
      </td>
      <td align="right" valign="middle">
        <span style="color: #565f89; font-size: 12px;">JSON Configuration</span>
      </td>
    </tr>
  </table>
  ...
  <ul style="margin: 12px 0 0 20px; padding: 0; font-size: 13px; line-height: 1.8;">
    <li>🔬 <b>Current Work</b>: Developing <b>LingoLens</b> (macOS Real-time OCR Translator) and <b>ska_manager</b> (Study room seat system).</li>
    <li>💬 <b>Interests</b>: Discord Bot development, API automation, and LLM integrations.</li>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td align="left" valign="middle">
        ...
        <span style="color: #ff9e64; font-size: 16px; margin: 0 4px;">●</span>
        <span style="color: #1abc9c; font-size: 16px;">●</span>
        <b style="color: #70a5fd; margin-left: 10px; font-size: 14px;">tech_stack.env</b>
      </td>
      <td align="right" valign="middle">
        <span style="color: #565f89; font-size: 12px;">Environment Variables</span>
      </td>
    </tr>
  </table>
  <hr style="border: 0; border-top: 1px solid #24283b; margin: 12px 0;">
...
<div style="background-color: #1a1b26; border: 1px solid #24283b; border-top: 1px solid #383e5a; border-left: 1px solid #383e5a; border-bottom: 3px solid #0d0e15; border-right: 3px solid #0d0e15; border-radius: 12px; padding: 20px; font-family: monospace; color: #a9b1d6; margin: 20px 0; box-shadow: 0 4px 20px rgba(0,0,0,0.3);">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td align="left" valign="middle">
        ...
        <span style="color: #ff9e64; font-size: 16px; margin: 0 4px;">●</span>
        <span style="color: #1abc9c; font-size: 16px;">●</span>
        <b style="color: #70a5fd; margin-left: 10px; font-size: 14px;">projects_showcase.md</b>
      </td>
      <td align="right" valign="middle">
        <span style="color: #565f89; font-size: 12px;">Markdown Documentation</span>
      </td>
    </tr>
  </table>
  <hr style="border: 0; border-top: 1px solid #24283b; margin: 12px 0;">
  ...
  <details>
    ...
    <ul style="margin: 10px 0 0 20px; padding: 0; font-size: 13px; line-height: 1.8;">
      <li><a href="https://github.com/SKR6582/flutterewind" style="color: #a9b1d6; text-decoration: none;">flutterewind</a> - Screen activity capturing rewind utility.</li>
      <li><a href="https://github.com/SKR6582/BCD2025-AI" style="color: #a9b1d6; text-decoration: none;">BCD2025-AI</a> - Human vs AI game board challenge.</li>
      <li><a href="https://github.com/SKR6582/seven_challenge" style="color: #a9b1d6; text-decoration: none;">Seven Challenge</a> - Timing precision game.</li>
      <li><a href="https://github.com/SKR6582/yt_tools" style="color: #a9b1d6; text-decoration: none;">yt_tools</a> - Video download script library.</li>
    </ul>
  </details>
</div>
...
<div style="background-color: #1a1b26; border: 1px solid #24283b; border-top: 1px solid #383e5a; border-left: 1px solid #383e5a; border-bottom: 3px solid #0d0e15; border-right: 3px solid #0d0e15; border-radius: 12px; padding: 20px; font-family: monospace; color: #a9b1d6; margin: 20px 0; box-shadow: 0 4px 20px rgba(0,0,0,0.3);">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td align="left" valign="middle">
        ...
        <span style="color: #ff9e64; font-size: 16px; margin: 0 4px;">●</span>
        <span style="color: #1abc9c; font-size: 16px;">●</span>
        <b style="color: #70a5fd; margin-left: 10px; font-size: 14px;">Antigravity Activity Dashboard</b>
      </td>
      <td align="right" valign="middle">
        <span style="color: #565f89; font-size: 12px;">Gemini 3.5 Flash (High)</span>
      </td>
    </tr>
  </table>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="50%" align="center">
        <img src="https://github-readme-stats.vercel.app/api?username=SKR6582&show_icons=true&include_all_commits=true&count_private=true&bg_color=00000000&hide_border=true&title_color=70a5fd&icon_color=ff007c&text_color=a9b1d6" alt="GitHub Stats" width="95%" />
      </td>
      <td width="50%" align="center">
        <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=SKR6582&layout=compact&bg_color=00000000&hide_border=true&title_color=70a5fd&icon_color=ff007c&text_color=a9b1d6" alt="Top Languages" width="95%" />
      </td>
    </tr>
  </table>
  <br>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td align="left" valign="middle">
        <span style="color: #565f89; font-size: 12px;">Status: Active</span>
      </td>
      <td align="right" valign="middle">
        <a href="https://skr6582-portfolio.vercel.app/" style="text-decoration: none;">
          <span style="background-color: #70a5fd; color: #1a1b26; padding: 6px 12px; border-radius: 4px; font-weight: bold; font-size: 12px; margin-right: 8px;">[ Website ]</span>
        </a>
        <a href="https://github.com/SKR6582" style="text-decoration: none;">
          <span style="background-color: #ff007c; color: white; padding: 6px 12px; border-radius: 4px; font-weight: bold; font-size: 12px;">[ Follow ]</span>
        </a>
      </td>
    </tr>
  </table>
